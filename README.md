...
JPEGでは何故、YCbCrカラーモデルが採用されているのかというと **人の目には輝度 (Y) の変化には敏感で色彩 (Cb, Cr) の変化には鈍感** という特性があります。詳細に関しては後で解説しますが、これを利用して **色彩情報の解像度を落としたり (色彩情報の間引き)** を行ったり、**色彩情報の量子化の高周波数成分対しより高い係数をかける**事により大幅に情報量を削り圧縮率を飛躍的に上げることが出来るため、JPEGではこのカラーモデルが※標準で採用されています。
